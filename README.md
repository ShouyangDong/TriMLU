...
python3 run_client.py my_kernel.py --model-type claude --model-id claude-3-5-sonnet-20240620 --op-type gemm

# 使用 Gemini 1.5 Pro
python3 run_client.py my_kernel.py --model-type gemini --model-id gemini-1.5-pro --op-type elewise
```
